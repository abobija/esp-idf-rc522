...
#define RC522_TASK_THROTTLING_MS_DEFAULT            (125)
#define RC522_TASK_THROTTLING_MS_MIN                (50)
#define RC522_TASK_STACK_SIZE_DEFAULT               (4 * 1024)
#define RC522_TASK_PRIORITY_DEFAULT                 (3)
#define RC522_PICC_VALID_ACTIVE_DURATION_MS_DEFAULT (500)
#define RC522_PICC_VALID_ACTIVE_DURATION_MS_MIN     (300)
